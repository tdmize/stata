...
Neither option may name one of the focal variables: `meinequality` does not estimate the ME inequality of a variable within levels of that same variable and exits with an error; [mecompare](../mecompare/help.html) handles that case.
