...
```{.stata-run}
. mecompare age collgrad race hours, models(basemod medmod) mod1name(Base Model) mod2name(Mediatio
> n Model)
...
. logit vhappy i.college i.married i.parent i.woman i.conserv i.reltrad i.year c.age##c.age, vce(r
> obust)
...
. logit vhappy i.college c.wages i.married i.parent i.woman i.conserv i.reltrad i.year c.age##c.ag
> e, vce(robust)
...
Model 3 (m3) is:
     logit vhappy i.college c.wages i.married i.parent i.woman i.conserv i.reltrad i.year c.age##c
> .age
Model 4 (m4) is:
     logit vhappy i.college c.wages c.occprest i.married i.parent i.woman i.conserv i.reltrad i.ye
> ar c.age##c.age
