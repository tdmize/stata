...
The article recommends plotting the predictions first, with `margins` and
`marginsplot`, and letting the plot guide the tests.
...
calculates these effects for both men and for women. The second difference --
whether the effect of aging is the same for men and women -- is `metest 1 -
2`.
