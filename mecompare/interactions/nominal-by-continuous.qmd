...
observed count to one more. For most applications, we recommend using the
default centered change.
...
is not significant. The instantaneous rate of change uses `amount(rate)`:
