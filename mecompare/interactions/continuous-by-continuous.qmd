...
. marginsplot, x(year1976) recastci(rline) ciopts(lpattern(dash) color(*.4)) ylabel(0(0.2)1) ///
...
. 
. coefplot pv_samemod, vertical recast(connected) ///
...
. 
. coefplot tm_samemod, vertical recast(connected) ///
>     ciopts(recast(rline) lpattern(dash) color(*.4)) yline(0) ///
