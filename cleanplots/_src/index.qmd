...
[trentonmize.com/software/cleanplots_r](https://www.trentonmize.com/software/cleanplots_r).
...
distinguishes about four or five groups. The palette, with its RGB and hex
codes (drawn with Ben Jann's `colorpalette` command):
